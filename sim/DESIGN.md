...
**Slice 27 — Player-player collisions** (in progress — Slice 27.1 ADR §22.24 drafted 2026-07-17, Slice 27.2 + 27.3 + 27.4 landed 2026-07-17)
...
- 27.5 New determinism goldens: `two_humans_collide_head_on_200_ticks_seed_42`, `collision_ball_passthrough_owned_400_ticks_seed_42`. These will instantiate `BasicPhysics` explicitly in their fixtures (same pattern today's goldens use for `StubPhysics`) so the collision behaviour is locked end-to-end.
