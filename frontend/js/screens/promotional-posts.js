...
class PromotionalPostsScreen extends Screen {
  ...
  renderList(container) {
    ...
    const quickAds = [
      ...
      },
      {
        ...
        imageUrl: '/images/posts/u23-ad-womens.png',
        ...
        <div class="card" style="padding:var(--space-3);margin-bottom:var(--space-3);border:2px solid rgba(99,102,241,0.3);">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
            <div style="display:flex;align-items:center;gap:10px;">
              <img src="/images/leagues/casa.png" style="height:32px;width:auto;object-fit:contain;" alt="CASA">
  ...
  async saveAndPublishQuickPost(key) {
    const quickAds = [
      { key: 'grassroots-brazil',    label: '🇧🇷 Brazil — Grassroots Cup',    imageUrl: 'https://footballhome.org/images/posts/grassroots-cup-ad-brazil.png', caption: `🇧🇷 WE'RE GOING TO THE PHILLY GRASSROOTS CUP — BRAZIL TEAM!\n\nLighthouse 1893 SC is proud to sponsor the Brazil team in the 2026 Philly Grassroots Cup — a World Cup-style city tournament representing 12 nations!\n\n🏆 3-game group stage + knockouts · 12 Nations\n📅 First match: June 7, 2026\n📍 Philadelphia, PA\n🥅 Final: June 19 at Drexel Vidas Field\n\n🌎 Open to ALL players — You do not have to be Brazilian!\n⚠️ Spots are limited and filling fast!\n\n#PhillyGrassrootsCup #Brazil #Lighthouse1893 #PhillySoccer #CASASoccer #WorldCup2026 #Lighthouse1893SC #GrassrootsCup` },
      { key: 'grassroots-puertorico', label: '🇵🇷 Puerto Rico — Grassroots Cup', imageUrl: 'https://footballhome.org/images/posts/grassroots-cup-ad-puertorico.png', caption: `🇵🇷 WE'RE GOING TO THE PHILLY GRASSROOTS CUP — PUERTO RICO TEAM!\n\nLighthouse 1893 SC is proud to sponsor the Puerto Rico team in the 2026 Philly Grassroots Cup — a World Cup-style city tournament representing 12 nations!\n\n🏆 3-game group stage + knockouts · 12 Nations\n📅 First match: June 7, 2026\n📍 Philadelphia, PA\n🥅 Final: June 19 at Drexel Vidas Field\n\n🌎 Open to ALL players — You do not have to be Puerto Rican!\n⚠️ Spots are limited and filling fast!\n\n#PhillyGrassrootsCup #PuertoRico #Lighthouse1893 #PhillySoccer #CASASoccer #WorldCup2026 #Lighthouse1893SC #GrassrootsCup` },
      { key: 'u23-mens',             label: `⚽ U23 Men's Team`,               imageUrl: 'https://footballhome.org/images/posts/u23-ad-mens.png',           caption: `Now forming Lighthouse Boys Club U23 team in CASA Men's U23 Premier League.\n\n📅 First Match: May 30, 2026\n🏆 League: CASA Soccer · Philadelphia\n📍 Philadelphia, PA\n🎯 Open to ALL players\n\n#Lighthouse1893 #U23 #PhillySoccer #CASASoccer #U23Soccer` },
      { key: 'u23-womens',           label: `⚽ U23 Women's Team`,             imageUrl: 'https://footballhome.org/images/posts/u23-ad-womens.png',           caption: `⚽ NOW FORMING: LIGHTHOUSE WOMEN'S CLUB U23!\n\nLighthouse Women's Club U23 is forming a team in partnership with CASA Soccer!\n\n📅 First Match: TBD\n🏆 League: CASA Soccer · Philadelphia\n📍 Philadelphia, PA\n🎯 Open to ALL players · Ages 16–25 eligible\n\n#Lighthouse1893 #U23 #PhillySoccer #CASASoccer #U23Soccer #Lighthouse1893SC #PhillyFootball #WomensSoccer` },
    ];
