...
class PromotionalPostsScreen extends Screen {
  ...
  renderList(container) {
    ...
    const quickAds = [
      ...
      },
      {
        ...
        imageUrl: '/images/posts/u23-ad-1778954703154.png',
      ...
      },
      {
        ...
        imageUrl: '/images/posts/u23-ad-1778946255917.png',
  ...
  async saveAndPublishQuickPost(key) {
    const quickAds = [
      ...
      { key: 'u23-mens',             label: `⚽ U23 Men's Team`,               imageUrl: 'https://footballhome.org/images/posts/u23-ad-1778954703154.png',           caption: `⚽ NOW FORMING: LIGHTHOUSE U23 MEN'S TEAM!\n\nLighthouse 1893 SC is forming a U23 Men's team in partnership with CASA Soccer!\n\n📅 First Match: May 30, 2026\n🏆 League: CASA Soccer · Philadelphia\n📍 Philadelphia, PA\n🎯 Open to ALL players\n\nInterested? Fill out the interest form directly:\n\n👉 https://tr.ee/hSxfHUV4jR\n\n#Lighthouse1893 #U23 #PhillySoccer #CASASoccer #U23Soccer #Lighthouse1893SC #PhillyFootball` },
