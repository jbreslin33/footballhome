...
class AdminClubScreen extends Screen {
  ...
  renderSubNavigation() {
    ...
    const sections = [
      ...
      { id: 'exhibit-social', icon: '📲', label: 'Exhibit → Social', description: 'Preview IG carousel / smashed poster / FB renders' },
  ...
  handleSubNavigation(section) {
    ...
    if (section === 'exhibit-social') {
      // Local preview of the rendered IG carousel + smashed/long posters + FB landscape.
      // The slideshow viewer reads PNGs from /images/posts/exhibit-pNN-*.png, which are
      // generated by `scripts/generate-exhibit-card.js <N>` and live-served by nginx.
