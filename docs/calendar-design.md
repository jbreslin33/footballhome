...
- **W3 follow-up (option C) — landed 2026-07-19** in migration
  `232-non-mens-practice-pickup-pools.sql`: Women/Boys/Girls Practice +
  Pickup pool teams (918–923), gcal aliases, membership requirements,
  and RSVP eligibility backfill. Girls finally have
  `gender_category='girls'` teams.
