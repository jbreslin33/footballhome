...
CREATE INDEX idx_division_team_players_division_team ON division_team_players(division_team_id);
...
COMMENT ON TABLE division_team_players IS 'Players assigned to division team entries';
...
CREATE INDEX idx_division_team_player_external_ids_player ON division_team_player_external_ids(division_team_player_id);
...
COMMENT ON TABLE division_team_player_external_ids IS 'Tracks external identifiers (e.g., APSL roster entry) for division team player entries';
...
-- Position assignments for division team players (what position they play for THIS division team)
...
CREATE INDEX idx_division_team_player_positions_player ON division_team_player_positions(division_team_player_id);
...
COMMENT ON TABLE division_team_player_positions IS 'Position assignment for division team players (what position they play for THIS division team)';
...
CREATE INDEX idx_division_team_coaches_division_team ON division_team_coaches(division_team_id);
...
CREATE INDEX idx_team_roster_scrape_targets_division_team ON team_roster_scrape_targets(division_team_id);
...
CREATE INDEX idx_team_season_stats_scrape_targets_division_team ON team_season_stats_scrape_targets(division_team_id);
