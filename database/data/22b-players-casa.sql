-- CASA Players
-- Generated at: 2025-12-17T23:37:09.739Z
...
VALUES (
  ...
  NULL,
  NULL,
  '2025-12-17T23:36:21.253Z',
  '2025-12-17T23:36:21.254Z'
)
ON CONFLICT (id) DO UPDATE SET
  preferred_position_id = COALESCE(EXCLUDED.preferred_position_id, players.preferred_position_id),
  photo_url = COALESCE(EXCLUDED.photo_url, players.photo_url),
...
VALUES (
  ...
  NULL,
  NULL,
  '2025-12-17T23:36:23.376Z',
  '2025-12-17T23:36:23.377Z'
)
ON CONFLICT (id) DO UPDATE SET
  preferred_position_id = COALESCE(EXCLUDED.preferred_position_id, players.preferred_position_id),
  photo_url = COALESCE(EXCLUDED.photo_url, players.photo_url),
