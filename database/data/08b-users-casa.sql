...
VALUES (
  ...
  NULL,
  true,
  '2025-12-17T13:06:28.029Z',
  '2025-12-17T13:06:28.030Z'
)
ON CONFLICT (id) DO UPDATE SET
  first_name = EXCLUDED.first_name,
  last_name = EXCLUDED.last_name,
