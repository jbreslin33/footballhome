...
INSERT INTO scrape_targets (id, source_system_id, scraper_type_id, target_type_id, url, label, is_active) VALUES
    ...
    (5, 3, 1, 1, 'https://www.cosmosoccerleague.com/CSL/Tables/', 'CSL 2025/2026 Season Structure', true),
    
    -- CSL Historical Seasons (active by default to populate on fresh rebuild)
    (6, 3, 1, 1, 'https://www.cosmosoccerleague.com/CSL/Tables/?Table_Season=395', 'CSL 2022/2023 Season Structure', true),
    (7, 3, 1, 1, 'https://www.cosmosoccerleague.com/CSL/Tables/?Table_Season=2596', 'CSL 2023/2024 Season Structure', true),
    (8, 3, 1, 1, 'https://www.cosmosoccerleague.com/CSL/Tables/?Table_Season=6026', 'CSL 2024/2025 Season Structure', true)
ON CONFLICT (id) DO NOTHING;
