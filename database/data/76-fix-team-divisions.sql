...
UPDATE teams 
SET division_id = 'd37eb44b-8e47-0004-9060-f0cbe96fe089'
...
FROM teams t
LEFT JOIN sport_divisions sd ON t.division_id = sd.id
LEFT JOIN team_players tp ON t.id = tp.team_id
WHERE t.division_id = 'd37eb44b-8e47-0004-9060-f0cbe96fe089'
