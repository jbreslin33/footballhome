...
INSERT INTO clubs (id, name, organization_id) VALUES (10005, 'Hoboken FC 1912', 10005) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
...
INSERT INTO clubs (id, name, organization_id) VALUES (10007, 'Central Park Rangers', 10007) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
...
INSERT INTO clubs (id, name, organization_id) VALUES (10009, 'Zum Schneider FC 03', 10009) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
...
INSERT INTO clubs (id, name, organization_id) VALUES (10011, 'NY International FC', 10011) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
...
INSERT INTO clubs (id, name, organization_id) VALUES (10029, 'NY Athletic Club', 10029) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
...
INSERT INTO clubs (id, name, organization_id) VALUES (10049, 'FC Hudson', 10049) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
