...
INSERT INTO organizations (id, name) VALUES (10001, 'Block FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
...
INSERT INTO organizations (id, name) VALUES (10015, 'NY Galicia') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10016, 'NY Shamrocks') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10017, 'NY Finest FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10018, 'Sporting Astoria South Bronx') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
...
INSERT INTO organizations (id, name) VALUES (10033, 'Riverside Squires') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10034, 'Panatha USA') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10035, 'Junior Mafia FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10036, 'NY Legacy FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10037, 'C.A. Islas Malvinas') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10038, 'Ollama FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10039, 'Barnstonworth Rovers FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10040, 'Warriors NYC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10041, 'NY Titans FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10042, 'NYC AlphaStars Club') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10043, 'Al-Asad') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10044, 'SC Gjoa') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (10045, 'Brooklyn New York SC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
...
INSERT INTO organizations (id, name) VALUES (10054, 'Polonez SC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
