...
ON CONFLICT (division_id, name) DO UPDATE SET
  ...
  source_system_id = EXCLUDED.source_system_id;
INSERT INTO teams (name, external_id, club_id, division_id, source_system_id)
SELECT 'Sewell''s Old Boys', '9096430-sewell''s-old-boys', 20009, d.id, 2
FROM divisions d
JOIN seasons s ON d.season_id = s.id
WHERE d.name = 'Philadelphia Liga 2'
  AND s.name = '2025/2026'
...
ON CONFLICT (division_id, name) DO UPDATE SET
  ...
  source_system_id = EXCLUDED.source_system_id;
INSERT INTO teams (name, external_id, club_id, division_id, source_system_id)
SELECT 'Gambeta FC', '9090891-gambeta-fc', 20015, d.id, 2
FROM divisions d
JOIN seasons s ON d.season_id = s.id
WHERE d.name = 'Boston Liga 1'
  AND s.name = '2025/2026'
...
ON CONFLICT (division_id, name) DO UPDATE SET
  ...
  source_system_id = EXCLUDED.source_system_id;
INSERT INTO teams (name, external_id, club_id, division_id, source_system_id)
SELECT 'Kutztown Men''s Soccer', '9090893-kutztown-men''s-soccer', 20016, d.id, 2
FROM divisions d
JOIN seasons s ON d.season_id = s.id
WHERE d.name = 'Lancaster Liga 1'
  AND s.name = '2025/2026'
...
ON CONFLICT (division_id, name) DO UPDATE SET
  ...
  source_system_id = EXCLUDED.source_system_id;
INSERT INTO teams (name, external_id, club_id, division_id, source_system_id)
SELECT 'Millersville Men''s Club Soccer', '9270318-millersville-men''s-club-soccer', 20020, d.id, 2
FROM divisions d
JOIN seasons s ON d.season_id = s.id
...
ON CONFLICT (division_id, name) DO UPDATE SET
  ...
  source_system_id = EXCLUDED.source_system_id;
INSERT INTO teams (name, external_id, club_id, division_id, source_system_id)
SELECT 'Lancaster Bible College', '9270318-lancaster-bible-college', 20021, d.id, 2
FROM divisions d
JOIN seasons s ON d.season_id = s.id
WHERE d.name = 'Lancaster Liga 2'
  AND s.name = '2025/2026'
...
ON CONFLICT (division_id, name) DO UPDATE SET
  ...
  source_system_id = EXCLUDED.source_system_id;
INSERT INTO teams (name, external_id, club_id, division_id, source_system_id)
SELECT 'West Chester University Club', '9270318-west-chester-university-club', 20022, d.id, 2
FROM divisions d
JOIN seasons s ON d.season_id = s.id
WHERE d.name = 'Lancaster Liga 2'
  AND s.name = '2025/2026'
...
ON CONFLICT (division_id, name) DO UPDATE SET
  ...
  source_system_id = EXCLUDED.source_system_id;
INSERT INTO teams (name, external_id, club_id, division_id, source_system_id)
SELECT 'YorkPA FC', '9270318-yorkpa-fc', 20023, d.id, 2
FROM divisions d
JOIN seasons s ON d.season_id = s.id
WHERE d.name = 'Lancaster Liga 2'
  AND s.name = '2025/2026'
