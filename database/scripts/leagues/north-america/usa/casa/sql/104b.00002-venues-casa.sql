...
INSERT INTO venues (name, address) VALUES ('Lighthouse Sport Complex Field', '101-199 East Erie Avenue, Philadelphia, PA 19140') ON CONFLICT (name) DO UPDATE SET address = COALESCE(EXCLUDED.address, venues.address);
...
INSERT INTO venues (name, address) VALUES ('Bartram Highschool', '5847R Elmwood Avenue, Philadelphia, PA 19143, US') ON CONFLICT (name) DO UPDATE SET address = COALESCE(EXCLUDED.address, venues.address);
INSERT INTO venues (name, address) VALUES ('South Philadelphia Super Site', '2926-2968 South 10th Street, Philadelphia, PA 19148, US') ON CONFLICT (name) DO UPDATE SET address = COALESCE(EXCLUDED.address, venues.address);
...
INSERT INTO venues (name, address) VALUES ('Ramp', '3300 Solly Avenue, Philadelphia, PA 19136, US') ON CONFLICT (name) DO UPDATE SET address = COALESCE(EXCLUDED.address, venues.address);
