...
INSERT INTO organizations (id, name) VALUES (20002, 'Phoenix SCM') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (20003, 'Philly BlackStars') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
...
INSERT INTO organizations (id, name) VALUES (20012, 'F&M FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (20013, 'Lancaster City FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
...
INSERT INTO organizations (id, name) VALUES (20017, 'YorkPA FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (20018, 'West Chester University Club') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
