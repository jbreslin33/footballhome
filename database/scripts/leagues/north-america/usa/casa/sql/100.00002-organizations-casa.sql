...
INSERT INTO organizations (id, name) VALUES (20002, 'Illyrians FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
...
INSERT INTO organizations (id, name) VALUES (20013, 'Keystone Elite') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) VALUES (20014, 'F&M FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
