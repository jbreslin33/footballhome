...
INSERT INTO organizations (id, name) SELECT 20000, 'Oaklyn United FC' WHERE NOT EXISTS (SELECT 1 FROM organizations WHERE name = 'Oaklyn United FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) SELECT 20001, 'Adé United FC' WHERE NOT EXISTS (SELECT 1 FROM organizations WHERE name = 'Adé United FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) SELECT 20002, 'Persepolis FC' WHERE NOT EXISTS (SELECT 1 FROM organizations WHERE name = 'Persepolis FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
...
INSERT INTO organizations (id, name) SELECT 20004, 'Lighthouse' WHERE NOT EXISTS (SELECT 1 FROM organizations WHERE name = 'Lighthouse') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO organizations (id, name) SELECT 20005, 'Illyrians FC' WHERE NOT EXISTS (SELECT 1 FROM organizations WHERE name = 'Illyrians FC') ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;
