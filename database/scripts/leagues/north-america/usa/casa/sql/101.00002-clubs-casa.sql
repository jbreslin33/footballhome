...
INSERT INTO clubs (id, name, organization_id) VALUES (20002, 'Philly BlackStars', 20002) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
...
INSERT INTO clubs (id, name, organization_id) VALUES (20013, 'F&M FC', 20013) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, organization_id = EXCLUDED.organization_id;
