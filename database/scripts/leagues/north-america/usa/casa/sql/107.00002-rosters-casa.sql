...
DELETE FROM rosters WHERE team_id IN (SELECT id FROM teams WHERE source_system_id = 2 AND external_id IN ('9090889-lighthouse-boys-club', '9096430-lighthouse-boys-club-u23', '9090889-oaklyn-united-fc-ii', '9090889-illyrians-fc', '9096430-phoenix-scr', '9090889-adé-united-fc', '9090889-philadelphia-sierra-stars', '9096430-persepolis-fc-ii', '9090889-philly-blackstars', '9096430-philadelphia-sc-select', '9090889-phoenix-scm', '9096430-sewell''s-old-boys'));
