...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Persepolis FC' AND t.source_system_id = 2
  AND per.first_name = 'Andrew' AND per.last_name = 'Blackwell'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Persepolis FC' AND t.source_system_id = 2
  AND per.first_name = 'Adam' AND per.last_name = 'Nork'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Illyrians FC' AND t.source_system_id = 2
  AND per.first_name = 'Siafa' AND per.last_name = 'Bongorlie'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Persepolis FC II' AND t.source_system_id = 2
  AND per.first_name = 'Ansu' AND per.last_name = 'Corneh'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Persepolis FC II' AND t.source_system_id = 2
  AND per.first_name = 'Emanuel' AND per.last_name = 'Forciniti'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Persepolis FC II' AND t.source_system_id = 2
  AND per.first_name = 'Amair' AND per.last_name = 'Russell'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'BCFC All Stars' AND t.source_system_id = 2
  AND per.first_name = 'John' AND per.last_name = 'Linnehan'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Flatley FC' AND t.source_system_id = 2
  AND per.first_name = 'Luke' AND per.last_name = 'Buiso'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Flatley FC' AND t.source_system_id = 2
  AND per.first_name = 'Gabriel' AND per.last_name = 'Goncalves'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Flatley FC' AND t.source_system_id = 2
  AND per.first_name = 'Erick' AND per.last_name = 'Hernandez'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Flatley FC' AND t.source_system_id = 2
  AND per.first_name = 'Adrien' AND per.last_name = 'Mehra'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
WHERE t.name = 'Jaguars United FC' AND t.source_system_id = 2
  AND per.first_name = 'Amari' AND per.last_name = 'Anwar'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Jaguars United FC' AND t.source_system_id = 2
  AND per.first_name = 'Andr̩s' AND per.last_name = 'Bustamante'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Jaguars United FC' AND t.source_system_id = 2
  AND per.first_name = 'Renato' AND per.last_name = 'Moreira'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
...
JOIN persons per ON pl.person_id = per.id
WHERE t.name = 'Jaguars United FC' AND t.source_system_id = 2
  AND per.first_name = 'Paulo' AND per.last_name = 'Santos'
ON CONFLICT (team_id, player_id, joined_at) DO UPDATE SET
  jersey_number = EXCLUDED.jersey_number;
