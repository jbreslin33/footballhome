...
INSERT INTO persons (first_name, last_name, birth_date) 
VALUES ('Alfaro', 'Kelvin Everto', NULL) 
ON CONFLICT (first_name, last_name) DO UPDATE SET
  birth_date = COALESCE(EXCLUDED.birth_date, persons.birth_date);
INSERT INTO players (person_id, source_system_id) 
SELECT id, 1 FROM persons 
WHERE first_name = 'Alfaro' AND last_name = 'Kelvin Everto' 
ON CONFLICT (person_id) DO NOTHING;
INSERT INTO player_sources (player_id, source_system_id, external_id, team_external_id) 
SELECT pl.id, 1, 'lighthouse-1893-sc-alfaro-kelvin-everto', '116079'
FROM players pl 
JOIN persons per ON pl.person_id = per.id 
WHERE per.first_name = 'Alfaro' AND per.last_name = 'Kelvin Everto' 
ON CONFLICT (source_system_id, external_id) DO UPDATE SET
  team_external_id = EXCLUDED.team_external_id;
...
INSERT INTO persons (first_name, last_name, birth_date) 
VALUES ('Gabriel', 'Alejandro Baccelliere Mariman', NULL) 
ON CONFLICT (first_name, last_name) DO UPDATE SET
  birth_date = COALESCE(EXCLUDED.birth_date, persons.birth_date);
INSERT INTO players (person_id, source_system_id) 
SELECT id, 1 FROM persons 
WHERE first_name = 'Gabriel' AND last_name = 'Alejandro Baccelliere Mariman' 
ON CONFLICT (person_id) DO NOTHING;
INSERT INTO player_sources (player_id, source_system_id, external_id, team_external_id) 
SELECT pl.id, 1, 'lighthouse-1893-sc-gabriel-alejandro-baccelliere-mariman', '116079'
FROM players pl 
JOIN persons per ON pl.person_id = per.id 
WHERE per.first_name = 'Gabriel' AND per.last_name = 'Alejandro Baccelliere Mariman' 
ON CONFLICT (source_system_id, external_id) DO UPDATE SET
  team_external_id = EXCLUDED.team_external_id;
...
INSERT INTO persons (first_name, last_name, birth_date) 
VALUES ('Denzel', 'Ricardo Banegas Ortiz', NULL) 
ON CONFLICT (first_name, last_name) DO UPDATE SET
  birth_date = COALESCE(EXCLUDED.birth_date, persons.birth_date);
INSERT INTO players (person_id, source_system_id) 
SELECT id, 1 FROM persons 
WHERE first_name = 'Denzel' AND last_name = 'Ricardo Banegas Ortiz' 
ON CONFLICT (person_id) DO NOTHING;
INSERT INTO player_sources (player_id, source_system_id, external_id, team_external_id) 
SELECT pl.id, 1, 'lighthouse-1893-sc-denzel-ricardo-banegas-ortiz', '116079'
FROM players pl 
JOIN persons per ON pl.person_id = per.id 
WHERE per.first_name = 'Denzel' AND per.last_name = 'Ricardo Banegas Ortiz' 
ON CONFLICT (source_system_id, external_id) DO UPDATE SET
  team_external_id = EXCLUDED.team_external_id;
...
INSERT INTO persons (first_name, last_name, birth_date) 
VALUES ('Bryan', 'Anthony Garcia Sirias', NULL) 
ON CONFLICT (first_name, last_name) DO UPDATE SET
  birth_date = COALESCE(EXCLUDED.birth_date, persons.birth_date);
INSERT INTO players (person_id, source_system_id) 
SELECT id, 1 FROM persons 
WHERE first_name = 'Bryan' AND last_name = 'Anthony Garcia Sirias' 
ON CONFLICT (person_id) DO NOTHING;
INSERT INTO player_sources (player_id, source_system_id, external_id, team_external_id) 
SELECT pl.id, 1, 'lighthouse-1893-sc-bryan-anthony-garcia-sirias', '116079'
FROM players pl 
JOIN persons per ON pl.person_id = per.id 
WHERE per.first_name = 'Bryan' AND per.last_name = 'Anthony Garcia Sirias' 
ON CONFLICT (source_system_id, external_id) DO UPDATE SET
  team_external_id = EXCLUDED.team_external_id;
