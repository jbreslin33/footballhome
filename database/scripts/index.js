...
async function generateApslSql(conferences, parser, allPlayers, allMatches, targetIds = {}) {
  ...
  sportDivisionLines.push('INSERT INTO sport_divisions (id, club_id, display_name, sport, is_active) VALUES');
  sportDivisionLines.push("    (1, 1, 'Lighthouse Soccer', 'Soccer', true)");
  ...
  teams.forEach((team, idx) => {
    ...
    sportDivisionLines.push(',');
    sportDivisionLines.push(`    (${sportDivId}, ${clubId}, 'Soccer', 'Soccer', true)`);
  });
