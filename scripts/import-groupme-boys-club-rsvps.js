#!/usr/bin/env node
/**
 * Import Boys Club Liga 1 Chat RSVPs
 * 
 * Imports game RSVPs from the Lighthouse Boys Club Liga 1 chat.
 * 
 * Usage: node scripts/import-groupme-boys-club-rsvps.js
 */
...
async function importRsvps() {
  try {
    ...
    console.log(`📥 Fetching events from Boys Club chat (${BOYS_CLUB_GROUP_ID})...`);
    ...
    console.log('');
    console.log('✅ Boys Club RSVPs import complete');
