...
const OUT_FILE = path.join(POSTS, 'previews', 'new-club-ads-mockup.png');

const CARDS = {
  mens: {
    img:     path.join(POSTS, 'mens-club-ad.png'),
    label:   "Men's Club — APSL / Liga 1 (DIRECT)",
    ...
    ctaSmall:'leagueapps.com · Men\'s Club registration',
    ctaBtn:  'Sign Up',
  },
  womens: {
    img:     path.join(POSTS, 'womens-club-ad.png'),
    label:   "Women's Club — Tri County (DIRECT)",
    ...
    ctaSmall:'leagueapps.com · Women\'s Club registration',
    ctaBtn:  'Sign Up',
  },
  boysK12: {
    img:     path.join(POSTS, 'boys-club-k12-ad.png'),
    label:   'Boys Club K-12 (DIRECT)',
  ...
  girlsK12: {
    img:     path.join(POSTS, 'girls-club-k12-ad.png'),
    label:   'Girls Club K-12 (DIRECT)',
    ...
    <div class="col">
      ...
      <div class="ig-post">
        ...
        <div class="ig-cta-bar">
          ...
          <div class="cta-btn">${c.ctaBtn}</div>
        </div>
...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .grid { display:grid; grid-template-columns: 540px 540px; gap:30px; justify-content:center; }
  .col { width:540px; }
