#!/usr/bin/env node
/**
 * Import Old Timers Liga 2 Chat RSVPs
 * 
 * Imports game RSVPs from the Lighthouse Old Timers Liga 2 chat.
 * 
 * Usage: node scripts/import-groupme-old-timers-rsvps.js
 */
...
async function importRsvps() {
  try {
    ...
    console.log(`📥 Fetching events from Old Timers chat (${OLD_TIMERS_GROUP_ID})...`);
    ...
    console.log('');
    console.log('✅ Old Timers RSVPs import complete');
